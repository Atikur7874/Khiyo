...
//Fetch a cart for user or guest
  ...
  extraReducers: (builder) => {
    builder
      ...
      .addCase(removeFromCart.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload?.message || "Failed to update remove item";
      })
      ...
      .addCase(mergeCart.rejected, (state, action) => {
        state.loading = false;
        state.error = action.payload?.message || "Failed to update merge cart";
      });
  },
});
